...
def add_track(playlist,trackid):
    ...
    #Remove all recently played
    played=sp.current_user_recently_played(limit=50)
    sp.playlist_remove_all_occurrences_of_items(playlist_id=playlist, items=played)